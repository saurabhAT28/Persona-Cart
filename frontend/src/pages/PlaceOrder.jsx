...
const PlaceOrder = () => {
  ...
  const initPay=(order)=>{
    const options={
      // key: import.meta.enav.VITE_RAZORPAY_KEY_ID,
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t">
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        ...
        <div className="flex gap-3">
          <input required onChange={onChangeHandler} name='zipcode' value={formData.zipcode} type="number" placeholder='Postal Code' className="border border-gray-300 rounded py-1.5 px-3.5 w-full" />
